...
// USANDO SUA URL INTERNA (Padrão para rodar dentro da Render)
const connectionString = "postgresql://bancoown_user:XS6MaSiilRsUzGp7tSeihw5kpf2ESVhr@dpg-d76ulg0ule4c7396n1a0-a/bancoown?ssl=true";

const client = new Client({ connectionString });

const sql = `
-- 1. Tabelas Base (Caso alguma não exista)
...
-- 2. Injeção de Colunas Faltantes (O que está dando erro 500)
...
async function executar() {
    try {
        console.log("🚀 Iniciando conexão hacker com o banco...");
